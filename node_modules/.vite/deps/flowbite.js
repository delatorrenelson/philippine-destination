...
var Collapse = function() {
  function Collapse2(targetEl, triggerEl, options) {
    ...
    this._options = __assign3(__assign3({}, Default3), options);
    this._visible = false;
    this._init();
  }
    ...
    if ($triggerEl) {
      ...
      if ($dialEl) {
        ...
        new Dial($parentEl, $triggerEl, $dialEl, {
          triggerType: triggerType ? triggerType : Default4.triggerType
        });
      } else {
      ...
      if (!getDrawerInstance(drawerId, drawerInstances)) {
        drawerInstances.push({
          ...
          object: new Drawer($drawerEl, {
            ...
            bodyScrolling: bodyScrolling ? bodyScrolling === "true" ? true : false : Default6.bodyScrolling,
            backdrop: backdrop ? backdrop === "true" ? true : false : Default6.backdrop,
            edge: edge ? edge === "true" ? true : false : Default6.edge,
            edgeOffset: edgeOffset ? edgeOffset : Default6.edgeOffset
          })
        });
      }
    } else {
...
var Dropdown = function() {
  ...
  Dropdown2.prototype.show = function() {
    ...
    this._popperInstance.setOptions(function(options) {
      return __assign7(__assign7({}, options), { modifiers: __spreadArray(__spreadArray([], options.modifiers, true), [
  ...
  document.querySelectorAll("[data-dropdown-toggle]").forEach(function($triggerEl) {
    ...
    if ($dropdownEl) {
      ...
      new Dropdown($dropdownEl, $triggerEl, {
        ...
        offsetSkidding: offsetSkidding ? parseInt(offsetSkidding) : Default7.offsetSkidding,
        offsetDistance: offsetDistance ? parseInt(offsetDistance) : Default7.offsetDistance
      });
    } else {
      ...
      if (!getModalInstance(modalId, modalInstances)) {
        modalInstances.push({
          ...
          object: new Modal($modalEl, {
            placement: placement ? placement : Default8.placement,
            backdrop: backdrop ? backdrop : Default8.backdrop
          })
        });
      }
    } else {
  ...
  document.querySelectorAll("[data-popover-target]").forEach(function($triggerEl) {
    ...
    if ($popoverEl) {
      ...
      new Popover($popoverEl, $triggerEl, {
        ...
        offset: offset2 ? parseInt(offset2) : Default9.offset,
...
var Tooltip = function() {
  ...
  Tooltip2.prototype.show = function() {
    ...
    this._targetEl.classList.add("opacity-100", "visible");
    this._popperInstance.setOptions(function(options) {
      return __assign11(__assign11({}, options), { modifiers: __spreadArray3(__spreadArray3([], options.modifiers, true), [
        { name: "eventListeners", enabled: true }
      ], false) });
    });
    this._popperInstance.update();
  ...
  document.querySelectorAll("[data-tooltip-target]").forEach(function($triggerEl) {
    ...
    if ($tooltipEl) {
      ...
      new Tooltip($tooltipEl, $triggerEl, {
        placement: placement ? placement : Default11.placement,
