    ...
    <footer className="flex flex-col border-t-2 border-t-gray-300 my-20 px-4 md:p-0 gap-8">
      <div className="grid sm:grid-flow-col grid-flow-row py-4">
        ...
        <ul className="footer_item related-link text-blue-400 leading-loose">
          ...
          <li>
            <a href="#">To hellas objects long</a>
          </li>
          <li>
            <a href="#">Fabled left deeds grace</a>
          </li>
          <li>
            <a href="#">Charms a formed</a>
          </li>
          <li>
            <a href="#">Rake wrong longed</a>
          </li>
          <li>
            <a href="#">Revel heal breast</a>
          </li>
          <li>
            <a href="#">Revel heal breast</a>
          </li>
          <li>
            <a href="#">He holy alone him he</a>
          </li>
          <li>
            <a href="#">Loathed he deem found</a>
          </li>
          <li>
            <a href="#">Hope grace it longed</a>
          </li>
        </ul>
        ...
        <ul className="footer_item social text-blue-400 leading-loose">
          ...
          <li>
            <a href="#" id="fb" className="w-8 h-8 flex">
              <svg
          ...
          <li>
            <a href="#" id="twtr" className="w-8 h-8 flex">
              <svg
                className="fill-gray-500"
                viewBox="0 0 48 48"
                fill="none"
